...
<body style="margin:0; padding:0">
    <table align="center" width="100%" style="max-width: 800px;">
        ...
        <table width="100%" style="padding:10px 10px;">
            <tr>
                <td style="font-family:Arial; font-weight:bold; color:#5F5F5F; font-size:14px; line-height: 20px;">Nueva peticion de cambio creada por <span style="color:#a44f4f;"><?php echo $params['created_by'] ?></span> <br /> <span style="font-size:13px; color:#909090;">el <?php echo $params['date_created']; ?><span></td>
            </tr>
        </table>
